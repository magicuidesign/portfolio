...
const THEME = cn(
  ...
  'data-[level="0"]:fill-muted-foreground/10 hover:data-[level="0"]:fill-muted-foreground/25',
  'data-[level="1"]:fill-muted-foreground/30 hover:data-[level="1"]:fill-muted-foreground/50',
  'data-[level="2"]:fill-muted-foreground/55 hover:data-[level="2"]:fill-muted-foreground/75',
  'data-[level="3"]:fill-muted-foreground/80 hover:data-[level="3"]:fill-muted-foreground/95',
  'data-[level="4"]:fill-muted-foreground hover:data-[level="4"]:fill-foreground'
)
...
>(({ activity, dayIndex, weekIndex, className, children, ...props }, ref) => {
...
export const ContributionGraphCalendar = ({
  ...
  return (
    <div
      className={cn(
        "no-scrollbar max-w-full scroll-fade-x overflow-x-auto overflow-y-hidden py-1",
        className
      )}
      {...props}
    >
      ...
      >
        ...
        {!hideMonthLabels && (
          <g
            ...
            className="fill-muted-foreground text-[10px] font-sans selection:fill-selection-foreground"
          >
