...
- [Yelp Subtopics, Revisited](https://github.com/samgutentag/yelpsubtopics) — modernized my own 8-year-old NLP project with BERTopic, zero-shot classification, and an LLM insight layer
